...
- [ ] **Implement**: Add vector similarity search function
- [ ] **Test**: Create test script with sample embeddings and verify similarity search returns correct chunks
- [ ] **Implement**: Add conversation/message storage functions
...
- [ ] **Implement**: Add chunk_text function with paragraph/sentence splitting
- [ ] **Test**: Test with sample text, verify chunks are appropriate size (500-1000 tokens)
- [ ] **Implement**: Add count_tokens function
- [ ] **Test**: Test token counting with known text samples
- [ ] **Implement**: Create `backend/utils/validators.py` with validate_url function
- [ ] **Test**: Test with valid/invalid URLs, verify validation works correctly
- [ ] **Implement**: Add sanitize_input function
